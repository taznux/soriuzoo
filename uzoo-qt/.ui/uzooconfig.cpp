    ...
    : QDialog( parent, name, modal, fl )
{
	...
	setName( "UzooConfig" );
    resize( 561, 414 ); 
    setCaption( tr( "Configure SoriUzoo" ) );
    ...
    Layout10->addWidget( playerLineEdit );

    findplayerPBtn = new QPushButton( ButtonGroup1, "findplayerPBtn" );
    findplayerPBtn->setText( tr( "Find Player" ) );
    Layout10->addWidget( findplayerPBtn );
    ButtonGroup1Layout->addLayout( Layout10 );
    ...
    helpPBtn = new QPushButton( tab_2, "helpPBtn" );
    helpPBtn->setText( tr( "Run Help Browser" ) );
    tabLayout_2->addWidget( helpPBtn );

    licenseTextView = new QTextView( tab_2, "licenseTextView" );
    tabLayout_2->addWidget( licenseTextView );

    developerTextView = new QTextView( tab_2, "developerTextView" );
    developerTextView->setText( tr( "" ) );
    tabLayout_2->addWidget( developerTextView );
    configureTabWidget->insertTab( tab_2, tr( "Help&&License" ) );
    ...
    connect( findplayerPBtn, SIGNAL( clicked() ), this, SLOT( slotFindPlayer() ) );
    connect( downFolderPBtn, SIGNAL( clicked() ), this, SLOT( slotDownLoadFolder() ) );
    connect( helpPBtn, SIGNAL( clicked() ), this, SLOT( slotHelpBrowser() ) );
    ...
    setTabOrder( searchSpinBox, upFolderPBtn );
    setTabOrder( upFolderPBtn, upFolderComboBox );
    setTabOrder( upFolderComboBox, downFolderPBtn );
    setTabOrder( downFolderPBtn, downFolderLineEdit );
    setTabOrder( downFolderLineEdit, playerLineEdit );
    setTabOrder( playerLineEdit, findplayerPBtn );
    setTabOrder( findplayerPBtn, startPlayerCheckBox );
    setTabOrder( startPlayerCheckBox, laterPlayerSpinBox );
    setTabOrder( laterPlayerSpinBox, autoLoginCheckBox );
    setTabOrder( autoLoginCheckBox, useridLineEdit );
    setTabOrder( useridLineEdit, passwdLineEdit );
    setTabOrder( passwdLineEdit, versionCheckBox );
    setTabOrder( versionCheckBox, versionLineEdit );
    setTabOrder( versionLineEdit, applyPBtn );
    setTabOrder( applyPBtn, okPBtn );
    setTabOrder( okPBtn, cancelPBtn );
    setTabOrder( cancelPBtn, helpPBtn );
    setTabOrder( helpPBtn, licenseTextView );
    setTabOrder( licenseTextView, developerTextView );
}
...
void UzooConfig::slotHelpBrowser()
{
    qWarning( "UzooConfig::slotHelpBrowser(): Not implemented yet!" );
}
